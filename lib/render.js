...
const DEFAULT_TITLE = 'La Odisea 2026 Película Completa Español Latino HD';
...
function head({ title, description, url, image, robots, type }) {
  const finalTitle = title ? `${title} | ${SITE_NAME}` : 'Ver Vaiana (2026) Película Online en Español y Latino';
