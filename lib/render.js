...
function head({ title, description, url, image, robots, type }) {
  // Jika ada title spesifik (halaman detail film/seri), gunakan format film | CineBox. 
  // Jika di halaman utama (tanpa title), gunakan format SEO utama secara penuh tanpa nama brand.
