...
const DEFAULT_TITLE = 'CineBox · Películas y Series Online en Español';
...
function head({ title, description, url, image, robots, type }) {
  // Jika ini halaman utama (tidak ada title spesifik), gunakan format judul utama yang Anda pilih
  const finalTitle = title ? `${title} | ${SITE_NAME}` : 'Ver Vaiana (2026) Pelicula Online en Espanol y Latino';
